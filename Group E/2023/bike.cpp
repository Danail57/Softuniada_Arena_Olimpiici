...
// long long go_ahead_to_station(int n, int p, int staions[3])
// {
// 	long long 
// }


// long long int diff(int n, int p, int stations[3])
// {
// 	long long dist, dist2, dist3;
// 	long long distances[] = { dist, dist2, dist3 };
// 	long long nearest_dist_to_station = 0;

// 	for (int i = 0; i < 3; i++)
// 	{
// 		dist = abs(p - stations[i]);
// 		dist2 = abs(p - stations[i + 1]);
// 		dist3 = abs(p - stations[i + 2]);

// 		for (auto d: distances)
// 		{
// 			if (dist < nearest_dist_to_station || dist == nearest_dist_to_station)
// 			{
// 				nearest_dist_to_station = dist;
// 			}
// 		}
// 	}
// 	return abs(nearest_dist_to_station);
